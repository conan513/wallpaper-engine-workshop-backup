...
var foreground_settings = function(settings) {
    ...
    foregroundSettingsObject = document.getElementById('foreground-image');

    // Select foreground type
    var setforeground = function() {
        
        WALLPAPER.foreground.setImage(foregroundSettingsObject, true, true);
    }
    ...
    if (settings.foreground_image) {
        if (settings.foreground_image.value !== "") {
            foregroundSettingsObject.src = "file:///" + settings.foreground_image.value;
        } else {
            foregroundSettingsObject.src = null;
        }
        setforeground();
    }
